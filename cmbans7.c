...
/*		:: Matias Zaldarriaga, David N. Spergel, Uros Seljak																									*/
...
int main()
{
	...
	else
	{
		...
		FILE *DEfile;
		DEfile = fopen("myde.d","r");

		for(int deind=0;deind<ndemax;deind++)
		{
			fscanf(DEfile,"%lf %lf",&a_ndemax[deind],&omg_de[deind]); 
		//	printf("%e %e\n",a_ndemax[deind],omg_de[deind]); 
			}
